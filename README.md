...
| k6-caos | `python pruebas_k6/caos.py --fase 100k\|500k\|1M` | **Caos bajo carga REAL**: k6 empujando ~200 rps mientras los servicios se matan con un crash real (`os._exit(1)`) y **vuelven solos**. Mide contención (cero 500), ausencia de cascada y cuánto tarda cada uno en recuperarse, con línea de tiempo | según fase |
