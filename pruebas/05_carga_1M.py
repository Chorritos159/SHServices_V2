...
if __name__ == "__main__":
    nivel_carga(
        ...
        nodos=int(os.environ.get("NODOS", "6")),
        bloque=int(os.environ.get("BLOQUE", "20")),
        duracion_seg=int(os.environ.get("DURACION", "1400")),
        total=int(os.environ.get("TOTAL", "25000")),  # 10 min (la más larga)
    )
